package com.lypaka.pixelskills.Listeners.Generations.Fisherman;
...
public class BPSFishListener {

    @SubscribeEvent
    public void onFish (FishSpawnEvent event) {
        ...
        String rod = event.getInfo().getRod();
        if (rod.contains("old")) {
